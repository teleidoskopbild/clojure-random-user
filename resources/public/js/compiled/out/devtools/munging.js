...
var temp__5718__auto____$1 = (o21964["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21965 = temp__5718__auto____$1;
return (o21965["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21291__auto__ = f;
return (o__21291__auto__["toString"]).call(o__21291__auto__);
} else {
return "";
}
}catch (e21966){var _ = e21966;
return "";
}});
...
try{var o__21291__auto___21968 = t;
(o__21291__auto___21968["cljs$lang$ctorPrWriter"]).call(o__21291__auto___21968,t,writer);
}catch (e21967){var __21969 = e21967;
}
...
var char_code = (function (){var o__21291__auto__ = (new String(char$));
return (o__21291__auto__["charCodeAt"]).call(o__21291__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21291__auto__ = String;
return (o__21291__auto__["fromCharCode"]).call(o__21291__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21970 = num_code;
switch (G__21970) {
case (1):
return (185);
...
var o__21291__auto__ = String;
return (o__21291__auto__["fromCharCode"]).call(o__21291__auto__,superscript_code);
});
/**
...
}catch (e21972){var _e__21298__auto__ = e21972;
return false;
}})())){
...
var vec__21973 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21973,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o21976 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21976["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21977 = temp__5718__auto____$1;
return (o21977["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21980){
var vec__21981 = p__21980;
var ns_detector = cljs.core.nth.call(null,vec__21981,(0),null);
...
var G__21987 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21988 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21987;
remaining_tokens = G__21988;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21978){
var G__21979 = cljs.core.first.call(null,seq21978);
var seq21978__$1 = cljs.core.next.call(null,seq21978);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21979,seq21978__$1);
}));
...
var vec__21992 = cljs.core.split_with.call(null,(function (p1__21991_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21991_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21992,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21992,(1),null);
...
var vec__21998 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21998,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21998,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22001 = cljs.core.rest.call(null,remaining_tokens);
var G__22002 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22001;
name_tokens = G__22002;
continue;
} else {
...
var vec__22005 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22005,(0),null);
var arity = cljs.core.nth.call(null,vec__22005,(1),null);
var vec__22008 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22008,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22008,(1),null);
var vec__22011 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22011,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22011,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22011,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22011,(3),null);
...
var vec__22017 = result;
var munged_ns = cljs.core.nth.call(null,vec__22017,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22017,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22017,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22017,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22017,(4),null);
var arity = cljs.core.nth.call(null,vec__22017,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22021 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22021,(0),null);
var args = cljs.core.nth.call(null,vec__22021,(1),null);
var vec__22024 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22024,(0),null);
var name = cljs.core.nth.call(null,vec__22024,(1),null);
...
var G__22027 = (arity + (1));
var G__22028 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22029){
var vec__22030 = p__22029;
var arity = cljs.core.nth.call(null,vec__22030,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22030,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22033_SHARP_){
return cljs.core.get.call(null,arities,p1__22033_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22034_SHARP_){
return cljs.core.drop.call(null,(2),p1__22034_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22041 = arguments.length;
var i__4737__auto___22042 = (0);
while(true){
if((i__4737__auto___22042 < len__4736__auto___22041)){
args__4742__auto__.push((arguments[i__4737__auto___22042]));

var G__22043 = (i__4737__auto___22042 + (1));
i__4737__auto___22042 = G__22043;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22037){
var vec__22038 = p__22037;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22038,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22035){
var G__22036 = cljs.core.first.call(null,seq22035);
var seq22035__$1 = cljs.core.next.call(null,seq22035);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22036,seq22035__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22046__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22046__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22046__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22046__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22047 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22047,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22047,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22047,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22047,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22047,(4),null);
var arity = cljs.core.nth.call(null,vec__22047,(5),null);
...
var o__21291__auto__ = f;
return (o__21291__auto__["getBasis"]).call(o__21291__auto__);
});
/**
...
}catch (e22051){var _e__21298__auto__ = e22051;
...
var G__22052 = (obj[cljs.core.first.call(null,path)]);
var G__22053 = cljs.core.rest.call(null,path);
obj = G__22052;
path = G__22053;
continue;
} else {
...
var _STAR_ = (function (accum,p__22054){
var vec__22055 = p__22054;
var bit = cljs.core.nth.call(null,vec__22055,(0),null);
var protocol = cljs.core.nth.call(null,vec__22055,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22058){
var vec__22059 = p__22058;
var ns = cljs.core.nth.call(null,vec__22059,(0),null);
var name = cljs.core.nth.call(null,vec__22059,(1),null);
var selector = cljs.core.nth.call(null,vec__22059,(2),null);
...
var post_process = (function (p__22063){
var vec__22064 = p__22063;
var munged_name = cljs.core.nth.call(null,vec__22064,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22064,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22062_SHARP_){
return (obj[cljs.core.first.call(null,p1__22062_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1738875618049
