...
var file = cljs.core.get.call(null,map__24576__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__24576__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__24576__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e24575){var _e = e24575;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___24578 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___24578)){
var seen_errors_24579 = temp__5718__auto___24578;
if(cljs.core.truth_(seen_errors_24579.has(self))){
} else {
seen_errors_24579.add(self);

var temp__5720__auto___24580 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___24580)){
var sense_24581 = temp__5720__auto___24580;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24581)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1738875619947
