...
return (new CustomEvent(event_name,(function (){var obj28017 = ({"detail":data});
return obj28017;
})()));
} else {
...
var f = (function (){var pred__28024 = cljs.core._EQ_;
var expr__28025 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28024.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28025))){
return (function (p1__28018_SHARP_){
return console.warn(p1__28018_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28024.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28025))){
return (function (p1__28019_SHARP_){
return console.debug(p1__28019_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28024.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28025))){
return (function (p1__28020_SHARP_){
return console.error(p1__28020_SHARP_);
});
} else {
return (function (p1__28021_SHARP_){
return console.log(p1__28021_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28028){
...
var eval_fn = cljs.core.get.call(null,map__28029__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28031_SHARP_){
return new_def.callback(p1__28031_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28032){
var vec__28033 = p__28032;
var ky = cljs.core.nth.call(null,vec__28033,(0),null);
var v = cljs.core.nth.call(null,vec__28033,(1),null);
...
}catch (e28038){if((e28038 instanceof Error)){
var e = e28038;
return not_found;
} else {
throw e28038;
...
//# sourceMappingURL=utils.js.map?rel=1738875620816
